...
namespace Error
{
	ERROR error[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(306, "[SEM]# Превышено максимальное количество параметров функции"), 
		ERROR_ENTRY(307, "[SEM]# Слишком много параметров в вызове"),	
		...
		ERROR_ENTRY(316, "[SEM]# Недопустимое строковое выражение справа от знака \'=\'"),	
		...
		ERROR_ENTRY(682, "FFFFFFFFFFFFF"), ERROR_ENTRY_NODEF10(690),

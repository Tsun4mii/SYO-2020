...
//#define FST_NEG_INTLIT 5,	\
//	FST::NODE(1, FST::RELATION('-', 1)),\
//	FST::NODE(8, FST::RELATION('0', 2), FST::RELATION('1', 2), FST::RELATION('2', 2), FST::RELATION('3', 2), FST::RELATION('4', 2), FST::RELATION('5', 2), FST::RELATION('6', 2), FST::RELATION('7', 2)),\
...
#define FST_MREQUAL 2,	\
	FST::NODE(1, FST::RELATION('}', 1)), \
	FST::NODE()

#define FST_LSEQUAL 2,	\
	FST::NODE(1, FST::RELATION('{', 1)), \
	FST::NODE()
